...
public class Minigame3Scene extends Scene {
	...
	private RedCablePrefab redCable;
	private GreenCablePrefab greenCable;
	private BlueCablePrefab blueCable;
	private YellowCablePrefab yellowCable;
	...
	private void initCables() {
		redCable = new RedCablePrefab(startPoints.get(0), endPoints.get(0));
		greenCable = new GreenCablePrefab(startPoints.get(1), endPoints.get(1));
		blueCable = new BlueCablePrefab(startPoints.get(2), endPoints.get(2));
		yellowCable = new YellowCablePrefab(startPoints.get(3), endPoints.get(3));
	}
